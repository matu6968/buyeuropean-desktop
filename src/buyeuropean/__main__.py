...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        Usage:
        buyeuropean [--gtk4] [--qt6]

        Options:
        --gtk4: Force GTK4 user interface
        --qt6: Force Qt6 user interface
        """
    )
    ...
    ui_group.add_argument(
        "--gtk4", action="store_true", help="Force GTK4 user interface"
    )
    ui_group.add_argument(
        "--qt6", action="store_true", help="Force Qt6 user interface"
    )
